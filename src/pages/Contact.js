                        ...
                        <div className='icon-localisation'>
                            ...
                            <div className='container-overlay'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <path d="M6.9999 0.687927C3.52872 0.687927 0.70459 3.54429 0.70459 7.05509C0.70459 10.5659 3.52872 13.4217 6.9999 13.4217C10.4711 13.4217 13.2952 10.5659 13.2952 7.05509C13.2952 3.54429 10.4711 0.687927 6.9999 0.687927ZM6.9999 12.3471C4.11468 12.3471 1.76709 9.97324 1.76709 7.05509C1.76709 4.13694 4.11415 1.76255 6.9999 1.76255C9.88565 1.76255 12.2327 4.13641 12.2327 7.05509C12.2327 9.97378 9.88565 12.3471 6.9999 12.3471Z" fill="black"/>
                                </svg>                   
                            </div>
                        </div>
                        <div className='text'>
                            ...
                            <div className='adresse'>
                                <p> 17 Avenue Albert II </p>
                                <p> L’ Albu - C/O The Office </p>
                                <p> 98000 Monaco </p>
                            </div>
                        </div>
                    </div>
